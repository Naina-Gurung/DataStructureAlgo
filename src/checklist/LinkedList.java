...
public class LinkedList {
   ...
   public Node tail ;
    ...
    public void addNodeBeginning(TreeEmployee data){
        if(head ==  null){
            head = new Node(data);
        }else{
    ...
    public void printList(){
        Node current = head;
        while(current != null){
            System.out.println(current.data.e_id + "," + current.data.e_name + "," + current.data.designation);
...
*/
    public Node insertAtLast(TreeEmployee data){
        Node temp=new Node(data);
        if(null == tail){
            tail = new Node(data);
            head = tail;
...
//my version
    public Node insertAtLastWithoutTail(TreeEmployee data){
        Node temp = new Node(data);
        if(null == head){
            head = temp;
        }else{
...
*/
    ...
    public void deleteAfterNode(TreeEmployee data){
        Node current = head;
    ...
    public void deleteAfter(TreeEmployee data){
        Node current = head;
        Node prev = null;
        while(current.data != data){
           prev = current;
